...
- [`impactr`](https://lveras.com/impactr): a package focues on mechanical loading prediction through accelerometer data.
- [`accdata`](https://github.com/verasls/accdata): a data package with accelerometry physical activity datasets to be used with the `impactr` package.
- [`drat`](https://lveras.com/drat): a drat repository. [What is it?](https://github.com/eddelbuettel/drat)
